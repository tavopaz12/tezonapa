...
const links = [
  ...
  {
    title: 'Avisos',
    link: '/admin/dashboard/avisos',
    icon: <FontAwesomeIcon className="h-4 w-4" icon={faTriangleExclamation} />,
  },
  {
    title: 'Eventos',
    ...
    <header className="w-[20%] max-md:bg-white max-md:sticky max-md:z-10 max-md:top-0 max-md:w-full max-md:h-auto p-4 h-screen relative md:border-r-2 border-gray-200 shadow-md">
      <div className="flex items-center gap-4 max-md:gap-2 max-md:justify-between">
        ...
        <div className="md:hidden">
          <button className="font-bold text-gray-500 max-md:hover:text-red-600 flex gap-2 items-center">
      ...
      <button className="absolute max-md:hidden bottom-0 m-8 font-bold text-gray-700 hover:text-red-600 flex gap-4 items-center">
