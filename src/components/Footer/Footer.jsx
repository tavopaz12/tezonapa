    ...
    <div className="bottom-0 relative md:flex md:justify-between bg-[#2A2D34] w-full px-10 py-4">
      ...
      <div className="md:w-1/4 max-md:mt-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          />
          <div>
            <p className="text-[#2D974B] font-extrabold max-md:text-sm uppercase">Teléfonos</p>
            <p className="text-white font-semibold max-md:text-sm">278 736 0122</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          />
          <div>
            <p className="text-[#2D974B] font-extrabold uppercase max-md:text-sm">Dirección</p>
            <p className="text-white font-semibold max-md:text-sm">Carretera al Palmar s/n</p>
            <p className="text-white font-semibold max-md:text-sm">Col. Centro, CP. 95096</p>
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          />
          <div>
            <p className="text-[#2D974B] font-extrabold uppercase max-md:text-sm">Horarios</p>
            <p className="text-white font-semibold max-md:text-sm">
      ...
      <div className="md:w-1/4 p-4 max-md:mt-8">
        <iframe
